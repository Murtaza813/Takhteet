...
# Replace the st.markdown CSS section with this modern design:
...
<style>
    ...
    * {
    ...
    [data-theme="light"] .stNumberInput > div > div > input:focus {
        background: white !important;
    }
